...
public class SwaggerConfiguration {
	...
	// Información API
	private static final String title = "API Blockbuster";
	private static final String description = "API Gestion Videoclub Blockbuster";
	...
	@Bean
	public Docket api() {
		logger.debug("-- Application API Blockbuster: Cargando Docket de preferencias API");
	...
	private ApiInfo apiInfo() {
		...
		logger.debug("-- Application API Blockbuster: Cargando API info");
